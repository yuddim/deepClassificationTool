...
train_data_dir = 'D:/Datasets/cars_angles/train'
validation_data_dir = 'D:/Datasets/cars_angles/test'

train_tune_data_dir = 'D:/Datasets/cars_angles/train'
validation_tune_data_dir = 'D:/Datasets/cars_angles/test'
...
weights_path = 'car_5angles_weights_50_30_VGG.h5'
weights_tuned_path = 'car_5angles_weights_50_1_inceptionv3_wtd.h5'#'cars_direct_tuned.h5'
...
#model = inceptionV3m(input_shape, 9)
#
...
if(train_flag == True):
    ...
    test_path_gen('D:/Datasets/cars_angles/train', img_width, img_height, model,
                  save_e_path='D:/Datasets/cars_angles/errorresults_special_train_resnet',
                  save_tune_path='D:/Datasets/cars_angles/tune_special_train_resnet', save_errors=False,
                  clear_tune_path=False)
    test_path_gen('D:/Datasets/cars_angles/test', img_width, img_height, model,
                  save_e_path='D:/Datasets/cars_angles/errorresults_special_test_resnet',
                  save_tune_path='D:/Datasets/cars_angles/tune_special_test_resnet', save_errors=False, clear_tune_path=False)
    """
